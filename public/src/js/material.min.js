  ...
  (window.MaterialMenu = d),
    ...
    (d.prototype.init = function () {
      if (this.element_) {
        ...
        s &&
          ...
          i && ((this.forElement_ = i), i.addEventListener("click", this.handleForClick_.bind(this)), i.addEventListener("keydown", this.handleForKeyboardEvent_.bind(this))));
    ...
    (d.prototype.show = function (e) {
      if (this.element_ && this.container_ && this.outline_) {
        ...
        for (
          var i = this.Constant_.TRANSITION_DURATION_SECONDS * this.Constant_.TRANSITION_DURATION_FRACTION, n = this.element_.querySelectorAll("." + this.CssClasses_.ITEM), a = 0;
          a < n.length;
          a++
        ) {
          var l = null;
  ...
  (window.MaterialSlider = p),
    ...
    (p.prototype.updateValueStyles_ = function () {
      ...
      0 === e ? this.element_.classList.add(this.CssClasses_.IS_LOWEST_VALUE) : this.element_.classList.remove(this.CssClasses_.IS_LOWEST_VALUE),
        this.isIE_ ||
          ((this.backgroundLower_.style.flex = e), (this.backgroundLower_.style.webkitFlex = e), (this.backgroundUpper_.style.flex = 1 - e), (this.backgroundUpper_.style.webkitFlex = 1 - e));
    }),
          ...
          function () {
            this.element_.setAttribute("aria-hidden", "true"),
              ...
              Boolean(this.actionElement_.getAttribute("aria-hidden")) ||
                (this.setActionHidden_(!0), (this.actionElement_.textContent = ""), this.actionElement_.removeEventListener("click", this.actionHandler_)),
    ...
    (L.prototype.init = function () {
      if (this.element_ && ((this.label_ = this.element_.querySelector("." + this.CssClasses_.LABEL)), (this.input_ = this.element_.querySelector("." + this.CssClasses_.INPUT)), this.input_)) {
        this.input_.hasAttribute(this.Constant_.MAX_ROWS_ATTRIBUTE) &&
          ((this.maxRows = parseInt(this.input_.getAttribute(this.Constant_.MAX_ROWS_ATTRIBUTE), 10)), isNaN(this.maxRows) && (this.maxRows = this.Constant_.NO_MAX_ROWS)),
    ...
    (f.prototype.screenSizeHandler_ = function () {
      this.screenSizeMediaQuery_.matches
        ...
        : (this.element_.classList.remove(this.CssClasses_.IS_SMALL_SCREEN),
          this.drawer_ && (this.drawer_.classList.remove(this.CssClasses_.IS_DRAWER_OPEN), this.obfuscator_.classList.remove(this.CssClasses_.IS_DRAWER_OPEN)));
    }),
